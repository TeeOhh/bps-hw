...
(defun quotize (pattern)
   "Given pattern, create evaluatable form that will return the original
    pattern, but also replace pattern variables with their bindings."
...
(defmacro rlet (var-specs &rest body)
   "In context of rule body, define new pattern variables."
...
(defun pattern-free-variables (pattern)
   "Return all unbound pattern variables."
